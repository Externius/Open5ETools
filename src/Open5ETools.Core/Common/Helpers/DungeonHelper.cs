...
public class DungeonHelper(IAppDbContext context) : IDungeonHelper
{
    ...
    private List<Models.Json.Monster> GetMonsters(IEnumerable<Models.Json.Monster> monsters)
    {
    ...
    public static int GetMonsterXp(Models.Json.Monster monster)
    {
        return Constants.ChallengeRatingXp[Constants.ChallengeRating.IndexOf(monster.ChallengeRating)];
    }
